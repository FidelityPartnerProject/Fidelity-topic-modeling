...
#   ungroup() %>%
#   ggplot(aes(tf_idf, fct_reorder(lemma, tf_idf), fill = id)) +
#   geom_col(show.legend = FALSE) +
...
custom stop words: cutoff should be carefully choose, depends on how much data we have
